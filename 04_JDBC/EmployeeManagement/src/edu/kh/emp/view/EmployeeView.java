...
public class EmployeeView {
	...
	private void selectJobAvgSalary() throws SQLException {
		System.out.println("< 직급별 급여 평균 조회  >");
		
		System.out.print("");
		
		Map<String, String> map = service.selectJobAvgSalary();
	...
	private void selectEmpNo() throws Exception {
		...
		System.out.print("검색할 사원의 주민번호를 입력하세요: ");
	...
	private void selectDeptTotalSalary() throws SQLException {
	...
	private void selectSalaryEmp() throws Exception {
		...
		empList = service.selectSalaryEmp(input);
	...
	private void selectDeptEmp() throws Exception {
		...
		System.out.print("검색할 사원의 부서: ");
		String input = sc.next();
		
		List<Employee> empList	= service.selectAll();
		
		empList = service.selectDeptEmp(input);
	...
	public void selectEmpId() throws Exception{
		System.out.println("사번이 일피하는 사원 정보 조회");
	 ...
	 * @param emp
	 */
	public void printOne(Employee emp) throws Exception{
		if(emp == null) {
			System.out.println("조회된 사원 정보가 없습니다.");
