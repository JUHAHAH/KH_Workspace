...
public class EmployeeService {
	...
	public List<Employee> selectDeptEmp(String input) throws SQLException {
		Connection conn = getConnection();
		
		List<Employee> list = dao.selectDeptEmp(conn, input);
		
		return list;
	}

	public List<Employee> selectSalaryEmp(int input) throws SQLException {
		Connection conn = getConnection();
	...
	public Map<String, String> selectJobAvgSalary() throws SQLException {
		Connection conn = getConnection();
		
		Map<String, String> map = dao.selectJobAvgSalary(conn);
